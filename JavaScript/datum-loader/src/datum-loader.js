...
function setupUI(config, app) {
	...
	// hook source IDs
	const sourceIdsTextarea = select('#criteria-form textarea[name="sourceIds"]').on('change', function() {
		/** @type {string} */
		const str = this.value;
		if ( str ) {
...
export default function startApp() {
	var config = new Configuration(Object.assign({nodeId:251},
